...
Files containing GUI changes/addition : 
 ...
 - neuroconstruct/project/RegionTypeHelper.java

 - neuroconstruct/project/ArbitraryRegion.java
...
This is integrated with neuroconstruct's frontend API through /neuroconstruct/gui/MainFrame.java 
