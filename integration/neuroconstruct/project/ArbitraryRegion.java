...
public class ArbitraryRegion extends Region
{
    ...
    public ArbitraryRegion(float x, float y, float z, float radius)
    {
        super.setDescription("Arbitrary");
        
        logger = new ClassLogger("ArbitraryRegion");

        parameterList = new InternalParameter[4];
        parameterList[0] = new InternalParameter("Z 1",
                                                 "Co-ordinate of the lower z plane",
                                                 x);

        parameterList[1] = new InternalParameter("Z 2",
                                                 "Co-ordinate of the upper z plane",
                                                 y);

        parameterList[2] = new InternalParameter("BLANK",
                                                 "NULL PARAMETERS",
                                                 z);
	
        parameterList[3] = new InternalParameter("BLANK",
                                                 "NULL PARAMETERS",
                                                 radius); 
    }
    ...
    {
        if (otherObj instanceof ArbitraryRegion)
        {
            ArbitraryRegion other = (ArbitraryRegion) otherObj;
    ...
    public Object clone()
    {
        ArbitraryRegion region = new ArbitraryRegion();
    ...
    {
        ArbitraryRegion newSphere = new ArbitraryRegion(this.getCentre().x + trans.x,
    ...
    {
        ArbitraryRegion s = new ArbitraryRegion();
