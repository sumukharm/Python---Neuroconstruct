...
/*
	...
	if (newRegion instanceof ArbitraryRegion)
	{
		...
		try
		{
			...
			//System.out.println("X-RANGE OF NEURAL CUBE : ");
			//String line3=buffer.readLine();				
		
			//System.out.println("Y-RANGE OF NEURAL CUBE : ");
			//String line4=buffer.readLine();				
			
			//System.out.println("Y-RANGE OF NEURAL CUBE : ");
			//String line5=buffer.readLine();	
			
			

			//System.out.println(line1);
			//System.out.println(line2);	
			String line3="python lines.py "+line1+" "+line2;		
			//System.out.println(line3);
			//String s="python better_plot.py "+line1+line2;		
		//
	//	try
	//	{
			String[] cmd = new String[] {"/bin/bash", "-c", line3};
